...
class Field {
    ...
    public function validate($value = null,$strMessage = null){
        ...
        $strMessage = str_replace("{table}", $this->getPattern(),$strMessage);
        ...
        if($this->isRequired() && empty($value)){
            throw new DatabaseException($strMessage,DatabaseException::ERROR_VALIDATE_ISREQUIRED);
            return false;
        }
        
        $pattern = $this->getPattern();
        if(!is_null($pattern) && !preg_match($pattern, $value)){
            throw new DatabaseException($strMessage,DatabaseException::ERROR_VALIDATE_PATTERN);
            return false;
        }
